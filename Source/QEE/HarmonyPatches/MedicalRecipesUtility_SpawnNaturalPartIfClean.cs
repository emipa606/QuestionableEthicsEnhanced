...
public static class MedicalRecipesUtility_SpawnNaturalPartIfClean
{
    private static void Postfix(ref Thing __result, Pawn pawn, BodyPartRecord part, IntVec3 pos, Map map)
    {
